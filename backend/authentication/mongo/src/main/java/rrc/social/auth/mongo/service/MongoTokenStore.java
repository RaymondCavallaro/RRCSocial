...
import rrc.social.auth.mongo.conversor.OAuth2AccessTokenAssembler;
import rrc.social.auth.mongo.conversor.OAuth2AuthenticationAssembler;
import rrc.social.auth.mongo.conversor.OAuth2RefreshTokenAssembler;
...
import rrc.social.auth.mongo.repository.OauthAccessTokenRepository;
import rrc.social.auth.mongo.repository.OauthCodeRepository;
import rrc.social.auth.mongo.repository.OauthRefreshTokenRepository;
...
public class MongoTokenStore implements TokenStore {
	...
	private void storeAuthentication(OAuth2Authentication authentication)
			throws JsonMappingException, JsonProcessingException {
		String authenticationId = oauth2AuthenticationAssembler.assembleAuthenticationCode(authentication);
		if (authenticationId == null) {
			Users user = usersRepository.findByUsernameAndClientId(authentication.getName(),
	...
	private OAuth2Authentication restoreAuthentication(String authentication)
			throws JsonMappingException, JsonProcessingException {
